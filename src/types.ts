...
export interface Order {
  ...
  totalAmount: number;
  subTotalAmount: number; // to track subtotal before discount
  discountAmount?: number; // to track applied discount
  couponCode?: string; // to track applied code
...
export interface UserProfile {
  ...
  email: string;
  isAdmin: boolean;
  isOwner?: boolean; // Check if user is owner (e.g. mail is talhaahmed13728@gmail.com)
  createdAt: any;
}
