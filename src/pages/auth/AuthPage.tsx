...
export default function AuthPage() {
  ...
  const handleUserSetup = async (userResult: any) => {
    ...
    if (!userSnap.exists()) {
      const isAdminUser = userResult.email === 'talhaahmed13728@gmail.com' || userResult.email === 'talhaxqutex@gmail.com';
      await setDoc(userRef, {
        email: userResult.email,
        isAdmin: isAdminUser,
        createdAt: serverTimestamp()
      });
    } else if ((userResult.email === 'talhaahmed13728@gmail.com' || userResult.email === 'talhaxqutex@gmail.com') && !userSnap.data().isAdmin) {
